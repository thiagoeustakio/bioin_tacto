...
void imuReadCallback(const bioin_tacto::raw_imuConstPtr &msg) {
    if (msg->sensor_id < NUM_SENSORS) {
            ...
            tmm_imus.imus[msg->sensor_id].gx = msg->gx;
            tmm_imus.imus[msg->sensor_id].gy = msg->gy;
            tmm_imus.imus[msg->sensor_id].gz = msg->gz;
            tmm_imus.imus[msg->sensor_id].ax = msg->ax;
            tmm_imus.imus[msg->sensor_id].ay = msg->ay;
            tmm_imus.imus[msg->sensor_id].az = msg->az;
            tmm_imus.imus[msg->sensor_id].mx = msg->mx*0.000001; //microtesla to tesla
            tmm_imus.imus[msg->sensor_id].my = msg->my*0.000001;
            tmm_imus.imus[msg->sensor_id].mz = msg->mz*0.000001;
        }
